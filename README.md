# @beautifulprincess/ngx-leaflet-lettermarkercluster

[![Build Status][travis-image]][travis-url]

[travis-url]: https://travis-ci.org/Beautifulprincess/ngx-leaflet-lettermarkercluster/
[travis-image]: https://travis-ci.org/Beautifulprincess/ngx-leaflet-lettermarkercluster.svg
...
npm install leaflet.markercluster @beautifulprincess/ngx-leaflet-lettermarkercluster
```
...
<div style="height: 400px;"
     ...
     [leafletLetterMarkerCluster]="letterMarkerClusterData"
     [leafletLetterMarkerClusterOptions]="letterMarkerClusterOptions">
</div>
```
...
There is an optional output event emitter that will expose the markercluster group being used by the plugin called ```leafletLetterMarkerClusterReady```.
...
<div style="height: 400px;"
     ...
     [leafletLetterMarkerCluster]="letterMarkerClusterData"
     [leafletLetterMarkerClusterOptions]="letterMarkerClusterOptions"
     (leafletLetterMarkerClusterReady)="letterMarkerClusterReady($event)">
</div>
```

```js
letterMarkerClusterReady(letterMarkerCluster: L.MarkerClusterGroup) {
	// Do stuff with group
}
```
